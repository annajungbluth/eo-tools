...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "number", help="The file to select from our compiled list of files", type=int
    )
    parser.add_argument(
        "--patch_size",
        type=int,
    ...
    if result is not None:
        ...
        logger.warning(
            f"No valid patch found for number {args.number} and {selected_file}. Skipping upload ..."
        )
